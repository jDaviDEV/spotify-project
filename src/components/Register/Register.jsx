        ...
        <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
          ...
          <form action="#" method="POST">
            ...
            <div className="mb-4 bg-sky-100 relative">
              ...
              <input type="text" id="username" name="username" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autoComplete="off" placeholder="Jhon Doe" />
            ...
            <div className="mb-4 relative">
              ...
              <input type={!isPassVisible ? "password" : "text"} id="confirmPassword" name="confirmPassword" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autoComplete="off" placeholder="●●●●●●●●" />
              {passIcon}
            </div>

            <button type="submit" className="bg-red-500 hover:bg-red-700 text-white font-semibold rounded-md py-2 px-4 w-full">Register</button>
          </form>
