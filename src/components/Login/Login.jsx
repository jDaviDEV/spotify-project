            ...
            <div className="bg-sky-100 flex justify-center items-center h-screen">
                ...
                <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
                    ...
                    <div className="flex justify-center gap-5 w-full ">
                        <button type="submit" onClick={authWithSpotify} className="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-700 text-sm text-gray-400 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
